...
$f1 = $_POST['Fein'];
$f2 = $_POST['Fefin'];
$FechaI = 'PerEnvioPrendas';
$FechaF = 'PerDateR';
$tabla = 'upersonalizacion';
$proc = 'Procesos';
//---------- Variables ----------
...
<body class="m-0 ">
  ...
  <div class="container" id="tablas">
    <div class="row" id="tablaPersonalizacion">
      ...
      <table class="table" width="">
        ...
        <tbody id="tabla">
          ...
          $query = "SELECT up.Idpedido, up.IdPer, up.tipoper, Proveedor, up.PerEnvioPrendas, up.PerDateR FROM upersonalizacion up
                        INNER JOIN proveedores ON up.ProvId = proveedores.ProvId
                        WHERE PerEnvioPrendas BETWEEN '$f1' AND '$f2'";
          ...
          ?>
            ...
            <tr>
              ...
              <td><?php echo $row['tipoper'] ?></td>
              <td><?php echo $row['Proveedor'] ?></td>
              <td><?php echo $row['PerEnvioPrendas'] ?></td>
              <td><?php echo $row['PerDateR'] ?></td>
  ...
  <script>
    function ocultar() {
      {
        var x = document.getElementById("tablaPersonalizacion");
